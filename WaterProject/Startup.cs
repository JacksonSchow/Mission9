...
namespace WaterProject
{
    public class Startup
    {
        ...
        {
            // Add service which tells the program to use the MVC pattern
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // Create a controller to chagne the slug. Endpoints are executed in order. If one matches, then that's the one the program takes
                endpoints.MapControllerRoute(
                    name: "Paging",
